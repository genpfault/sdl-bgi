...
compilers for DOS. It represented the \emph{de facto} standard for
...
correctly filled, and only using SOLID\_FILL.
...
\textbf{Note}: as of the current release, the pie slice is filled only
using SOLID\_FILL.
...
\textbf{Note}: as of the current release, the sector is filled only
using SOLID\_FILL.
